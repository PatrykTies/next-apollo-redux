...
/*!************************************!*\
  !*** ./lib/placeholder/actions.js ***!
  \************************************/
/*! exports provided: actionTypes, loadData, loadDataError */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _api_jsonPlaceholderApi_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../api/jsonPlaceholderApi.js */ "./lib/api/jsonPlaceholderApi.js");
const actionTypes = {
  LOAD_DATA: 'LOAD_DATA',
...
const loadData = id => async dispatch => {
  const response = await _api_jsonPlaceholderApi_js__WEBPACK_IMPORTED_MODULE_0__["default"].get(`/posts/${id}`);
  dispatch({
...
function reducer(state = initialState, action) {
  switch (action.type) {
    case _actions__WEBPACK_IMPORTED_MODULE_1__["actionTypes"].LOAD_DATA_SUCCESS:
      return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, state.data, action.payload.data);
...
const bindMiddleware = middleware => {
  if (true) {
    return Object(redux_devtools_extension__WEBPACK_IMPORTED_MODULE_3__["composeWithDevTools"])(Object(redux__WEBPACK_IMPORTED_MODULE_0__["applyMiddleware"])(...middleware));
  }
...
function configureStore(initialState) {
  const store = Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(_rootReducer__WEBPACK_IMPORTED_MODULE_2__["default"], initialState, bindMiddleware([redux_thunk__WEBPACK_IMPORTED_MODULE_1___default.a]));
  return store;
}
    ...
    static async getInitialProps(ctx) {
      ...
      if (true) {
        ...
        try {
          ...
          await Object(react_apollo__WEBPACK_IMPORTED_MODULE_5__["getDataFromTree"])(__jsx(react_apollo__WEBPACK_IMPORTED_MODULE_5__["ApolloProvider"], {
            client: apollo
...
/* harmony import */ var _lib_withApollo_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../lib/withApollo.js */ "./lib/withApollo.js");
...
/* harmony import */ var _lib_store__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../lib/store */ "./lib/store.js");
...
/* harmony default export */ __webpack_exports__["default"] = (next_redux_wrapper__WEBPACK_IMPORTED_MODULE_3___default()(_lib_store__WEBPACK_IMPORTED_MODULE_7__["default"])(MyApp));
